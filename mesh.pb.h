...
typedef struct _meshtastic_MqttClientProxyMessage {
    ...
    union _meshtastic_MqttClientProxyMessage_payload_variant {
        /* Bytes */
...
typedef struct _meshtastic_ClientNotification {
    ...
    char message[400];
    pb_size_t which_payload_variant;
    union _meshtastic_ClientNotification_payload_variant {
...
typedef struct _meshtastic_ChunkedPayloadResponse {
    ...
    uint32_t payload_id;
    pb_size_t which_payload_variant;
    union _meshtastic_ChunkedPayloadResponse_payload_variant {
